...
namespace NeuralNetworksLibrary
{
    public class Connection<NodeType>
        where NodeType : NodeCore<double, NodeType>
    {
        private NodeType _TargetNode;
        private double _ConnectionWeight;
        private Connection<NodeType> _OppositeConnection;
        ...
        {
            get { return _ConnectionWeight; }
            set { _ConnectionWeight = value; }
        }
        public Connection<NodeType> OppositeConnection
        {
            get { return _OppositeConnection; }
            set { _OppositeConnection = value; }
        }
        ...
        public Connection(NodeType NodeToConnect)
        {
            TargetNode = NodeToConnect;
            ConnectionWeight = 1;
        }

        public Connection(NodeType NodeToConnnect, double Weight)
        {
            TargetNode = NodeToConnnect;
